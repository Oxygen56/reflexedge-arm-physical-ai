...
| Public evidence | `reports/publication_validation.json` | fails closed until the corrected repository video and live demo match the local evidence snapshot |
| Submission package | `reports/buidl_validation.json` | fails closed until public evidence is synchronized and revalidated |
