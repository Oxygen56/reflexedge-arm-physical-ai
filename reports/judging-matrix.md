...
| --- | --- | --- |
| Technological implementation (40) | scalar FP32 baseline, int8 NEON kernel, compiler flags, Arm64 hardware log, raw benchmark JSON, safety regression tests | real Arm64 run; reproducible speed and model-size improvement; zero int8 BRAKE false-negative disagreements and zero added ground-truth false negatives |
...
| Unsafe quantization regression | full three-state action comparison plus explicit int8 BRAKE false-negative-disagreement and added-ground-truth-FN gates |
